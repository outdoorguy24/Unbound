...
const StartSaveLoadingScreen = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      router.push('/defend/SavedFocusSession')
    }, 3000)
  ...
  return (
    <View style={styles.safe}>
      ...
      >
        <Text style={styles.headerText}>{'your schedule\nis saving...'}</Text>
        <Animated.Image
        ...
        />
        <Image
          source={require("../../../assets/new-images/start-save-loading-text.png")}
          resizeMode={"contain"}
          style={{
...
export default StartSaveLoadingScreen;