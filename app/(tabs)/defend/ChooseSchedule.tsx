  ...
  return (
    <View style={styles.safe}>
      ...
      <View style={[styles.mainContainer, { marginTop: insets.top + scaleVertical(16) }]}>
        ...
        <Text style={styles.slogan}>Choose Your Schedule</Text>
        ...
        >
          ...
          >
            Save your scheduled block time to start when you want it or choose a time frame to start blocking immediately by choosing “start a block now” below. 
          </Text>
          <Text
            style={{
              marginTop: scale(14),
          ...
          >
            ...
            Once a block starts, there is NO way to end it early. You won’t be able to cancel it, you can’t delete the app, and there are ZERO workarounds. You’re welcome.
          </Text>
          </>}

          {sessions?.length && 
          <TouchableOpacity
            onPress={() => router.push("/defend/UpdateSchedule")}
            style={{
              marginTop: scale(24),
              borderRadius: 4,
              backgroundColor: "rgba(44, 23, 7, 0.6)",
        ...
        <View style={{
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              setTimeout(() => {
                router.push('/defend/StartSaveLoading')
              }, 1000)
            }}
            activeOpacity={0.9}
          >
            <Text style={styles.primaryText}>{"Save your scheduled block "}</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() => router.push("/defend/BlockNow")}
          >
            <View style={{
              flex: 1,
              flexDirection: "row",
