...
const Screen14 = ({ isActive }: { isActive?: boolean }) => {
  ...
  return (
    <View style={styles.safe}>
      <Image source={require("../../assets/new-images/onboarding-screen-14.png")} style={styles.image} />
      ...
      <View style={styles.textContainer}>
        ...
        >
          {'SO INSTEAD OF REACHING FOR YOUR PHONE EVERY TIME YOU\'re bored'}
        </Animated.Text>
      </View>
